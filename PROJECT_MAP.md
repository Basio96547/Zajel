...
| `:app:connectedDebugAndroidTest` | 27/27 | ⚠️ **رقم لا يمكن أن يكون صحيحاً اليوم.** المجموعة **لم تكن تُصرَّف** منذ استخراج `:core` — انظر التحذير أسفله. تُصرَّف الآن، لكنها **لم تُشغَّل** (لا جهاز موصول) |
