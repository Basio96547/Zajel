...
| `:app:connectedDebugAndroidTest` | **47/47** على SM-S938B / Android 16 | ✅ **شُغِّلت فعلاً 2026-07-31** — باستثناء `AckAuthenticationTest` (انظر التحذير المُتلِف أدناه). العدد **47 لا 27**؛ الرقم القديم متجاوَز مرتين: المجموعة نمت (آخرها ٤ اختبارات صندوق الوسائط)، وكانت معطّلة عن التصريف |
...
5. ~~`docs/adr/0001` (عزل فكّ الوسائط) مقترَح لم يُنفَّذ.~~ **نُفِّذ للصور 2026-07-31 وتُحقّق على جهاز.**
   ...
   **التحقق الحاسم تمّ على SM-S938B / Android 16**: العزل حقيقي (uid منفصل من فئة `u*_i*`)، والصورة المشوَّهة تفشل نظيفاً، و**`kill -9` على العملية المعزولة وسط الحياة لا يُسقط التطبيق والفكّ التالي يعيد بناءها**. المجموعة كاملة 47/47.
