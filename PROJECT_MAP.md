...
| `:app:testDebugUnitTest` (JVM، بلا جهاز) | **6/6** | ✅ شُغِّلت فعلاً 2026-07-31 |
| `:app:connectedDebugAndroidTest` | **47/47** على SM-S938B / Android 16 | ⚠️ شُغِّلت فعلاً 2026-07-31 **لكن قبل حارس قناة العودة** — انظر «حدّ التحقق» أدناه. باستثناء `AckAuthenticationTest` |
...
و`:app:testDebugUnitTest` مجموعة **منفصلة** (مصدر `src/test`) عددها 6 — لا تُجمع مع الـ47 ولا تُقارن بها.
